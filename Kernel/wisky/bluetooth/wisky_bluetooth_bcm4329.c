...
#define BT_GPIO_POWER           			WIFI_BT_POWER_PIN
#define IOMUX_BT_GPIO_POWER     rk29_mux_api_set(WIFI_BT_POWER_MUX_NAME, WIFI_BT_POWER_MUX_MODE);
#define BT_GPIO_RESET          				BT_RESET_PIN
#define BT_GPIO_WAKE_UP         			BT_WAKE_PIN
...
static int bcm4329_set_block(void *data, bool blocked)
{
		...
		gpio_request(RK29_PIN2_PB1, "");
		gpio_direction_input(RK29_PIN2_PB1);
		rk29_mux_api_set(GPIO2B0_UART2SIN_NAME, GPIO2L_GPIO2B0);
		gpio_request(RK29_PIN2_PB0, "");
		gpio_direction_input(RK29_PIN2_PB0);

		rk29_mux_api_set(GPIO2A7_UART2RTSN_NAME, GPIO2L_GPIO2A7);		
		gpio_request(RK29_PIN2_PA7, "");
		gpio_direction_input(RK29_PIN2_PA7);
		rk29_mux_api_set(GPIO2A6_UART2CTSN_NAME, GPIO2L_GPIO2A6);		
		gpio_request(RK29_PIN2_PA6, "");
		gpio_direction_input(RK29_PIN2_PA6);		
