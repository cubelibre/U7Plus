...
#include "wisky_codec_rt5631.h"
#include <linux/timer.h>

//#include "../../../drivers/video/rockchip/hdmi/rk30_hdmi.h"
...
#ifndef DEF_VOL
/*
Headphone Right Channel Volume Control (HPOVOLR)
00¡¯h: 0dB
~
1F¡¯h: -46.5dB, with 1.5dB/step
*/
	#if defined(HEADPHONE_VOLUME)
	#define DEF_VOL					HEADPHONE_VOLUME
	#else
...
#ifndef DEF_VOL_SPK
/*
	Speaker Right Channel Volume Control (SPKVOLR)
	00¡¯h: +12dB
	~
	08¡¯h: 0dB
	~
...
*/
	#if defined(SPEAKER_VOLUME)
	#define DEF_VOL_SPK				SPEAKER_VOLUME
	#else
	#define DEF_VOL_SPK				0xc4//0xC0:12DB,0xC1:10.5DB,0xC2:9DB,0xC4:6DB,0xC8:0DB
	#endif
#endif

/*Bist[15-12]:MIC1, Bits[11-8]:MIC2
MIC1 Input Boost Gain Control
0000¡¯b: Bypass
0001¡¯b: +20dB
0010¡¯b: +24dB
0011¡¯b: +30dB
...
Others : Reserved
*/
#define MIC_BOOST_GAIN_VOL	MIC_BOOST_GAIN
...
static struct rt5631_init_reg init_list[] = {
	...
	{RT5631_MIC_CTRL_2		, MIC_BOOST_GAIN_VOL},//0x4400},//0x8800},//0x6600}, //Mic1/Mic2 boost 40DB by default
...
#if defined(WISKY_BOARD_M876R_TV30)
...
#if 0
		if(hdmi){
			if(hdmi->switch_hdmi.state){
				return 0;//hdmi insert, do not enable speaker when start play audio
			}
		}
#endif
...
void codec_set_spk(bool on)
{
	...
	if(on){
		...
		//wisky[s]cd huaang@20120607^delete
		//snd_soc_dapm_enable_pin(&codec->dapm, "Headphone Jack");
		//snd_soc_dapm_enable_pin(&codec->dapm, "Ext Spk");
		//wisky[e]
		
		//wisky[s]cd huaang@20120607^add for speaker out switch
		rt5631_write_mask(rt5631_codec, RT5631_PWR_MANAG_ADD4,
				PWR_SPK_L_VOL, PWR_SPK_L_VOL);
		rt5631_write_mask(rt5631_codec, RT5631_PWR_MANAG_ADD1,
				PWR_CLASS_D, PWR_CLASS_D);
		rt5631_write_mask(rt5631_codec, RT5631_SPK_OUT_VOL,
				0, RT_L_MUTE);
