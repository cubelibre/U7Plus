...
#define WM_SPKL	0x10	/*LOUT2 Output Buffer*/
#define WM_SPKR	0x08	/*ROUT2 Output Buffer*/
#define WM_OUT3	0x02	/*OUT3 Output Buffer*/
#define WM_PLLEN	0x01 /*PLL EN*/
