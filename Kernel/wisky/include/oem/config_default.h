...
#define ANDROID_CONFIG_ZE     "V1.18_20121227"//ZE）客户的版本号 （字符串信息）
...
#define ANDROID_CONFIG_ZL     "android"//ZL）ADB名称显示信息 （客户需要在PC设备管理器中看到的ADB名称）
...
#define ANDROID_CONFIG_ZZ	"0" //ZY)是否使用3G通话功能，0--不使用，1--使用
...
#define ANDROID_CONFIG_Y8	"0" //Y8)解锁方式选择:0---Android默认解锁，1---Wisky解锁方式
...
#define ANDROID_CONFIG_YO	"0"//YO)是否显示设置菜单中内置3G 模块电源控制0-不显示，1-显示(默认0)
