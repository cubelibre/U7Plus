...
s32 gtp_i2c_read(struct i2c_client *client, u8 *buf, s32 len)
{
	...
	msgs[0].scl_rate = GT9XX_I2C_SPEED;
	...
	msgs[1].scl_rate = GT9XX_I2C_SPEED;
...
static int goodix_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    u16 version_info;
    struct goodix_platform_data1 *pdata = NULL;
    ...
    ts->abs_x_max = WISKY_TOUCH_WIDTH;
    ts->abs_y_max = WISKY_TOUCH_HEIGHT;
