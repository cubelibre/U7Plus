 ...
 * LOG
 * ------------------------------------------------------------
 * V001:20110224 cd huang
 *	1.Create wisky_lcd_w070dwb.c lcd driver for World chip W070DWB module.
 * 		W070DWB: world chip W070DWB lcd module
 * 			070:size 7Inches
 *			D:Digital
 *			W:15:9
 *			B:1024x600
...
#define OUT_CLK			51000000//60000000
#define LCDC_ACLK		500000000           //29 lcdc axi DMA 频率

/* Timing */
#define H_PW			120	//HYSNC Pulse width
#define H_BP			180	//HYSNC Blanking width
#define H_VD			WISKY_LCD_WIDTH	//horizontal line width
#define H_FP			20	//HYSNC front porch

#define V_PW			16	//VYSNC Pulse width
#define V_BP			14	//VYSNC Blanking
#define V_VD			WISKY_LCD_HEIGHT	//height
#define V_FP			8	//VYSNC front porch
