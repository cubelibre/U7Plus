...
/* Timing */
#define H_PW			100	//HYSNC Pulse width
#define H_BP			160	//HYSNC Blanking width
#define H_VD			WISKY_LCD_WIDTH	//horizontal line width
#define H_FP			160	//HYSNC front porch

#define V_PW			15	//VYSNC Pulse width
#define V_BP			23	//VYSNC Blanking
#define V_VD			WISKY_LCD_HEIGHT	//height
#define V_FP			12	//VYSNC front porch
