/* wisky/lcd/wisky_lcd_hsd070pfw3.c
 *
 ...
 * LOG
 * ------------------------------------------------------------
 * V001:20111117 cd huang
 *	1.Create for HSD070PFW3 LCD module driver.
 *		瀚斯宝丽（INNOLUX）HSD070PFW3 LCD Module：
 ×		LCD size：7.0Inch（Diagonal）
 ×		Resolution：1024x3(RGB)x600
 */
...
/* Timing */
#define H_PW			35	//HYSNC Pulse width
#define H_BP			244	//HYSNC Blanking width
#define H_VD			WISKY_LCD_WIDTH //'orizontal line width
#define H_FP			53	//HYSNC front porch

#define V_PW			5	//VYSNC Pulse width
#define V_BP			57	//VYSNC Blanking
#define V_VD			WISKY_LCD_HEIGHT //height
#define V_FP			4	//VYSNC front porch
