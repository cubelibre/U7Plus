 ...
 *	1.Create for AT070TNA2 LCD module driver.
...
/* Timing */
#define H_PW			50	//HYSNC Pulse width
#define H_BP			320	//HYSNC Blanking width
#define H_VD			WISKY_LCD_WIDTH //'orizontal line width
#define H_FP			10	//HYSNC front porch

#define V_PW			50	//VYSNC Pulse width
#define V_BP			35	//VYSNC Blanking
#define V_VD			WISKY_LCD_HEIGHT //height
#define V_FP			10	//VYSNC front porch
