 ...
 *	1.Create for AT070TN93 LCD module driver.
 *		奇美电子（INNOLUX）AT070TN93 LCD Module：
...
/* Timing */
#define H_PW			20	//HYSNC Pulse width
...
#define V_VD			WISKY_LCD_HEIGHT //eight
