...
struct ft5302_platform_data {
	u16     model;
	int     (*get_pendown_state)(void);
	int     (*init_platform_hw)(void);
	int     (*ft5302_platform_sleep)(void);
	int     (*ft5302_platform_wakeup)(void);
	void    (*exit_platform_hw)(void);
};
...
struct gt82x_platform_data {
	u16     model;
	int     (*get_pendown_state)(void);
	int     (*init_platform_hw)(void);
	int     (*gt82x_platform_sleep)(void);
	int     (*gt82x_platform_wakeup)(void);
	void    (*exit_platform_hw)(void);
};
...
struct zet6221_ts_platform_data {
	u16     model;
	int		pwr_pin;
	int		pwr_on_value;
	int		reset_pin;
...
struct dmard06_platform_data {
	u16     model;
	u16     swap_xy;
	int     (*get_pendown_state)(void);
	int     (*init_platform_hw)(void);
	int     (*dmard06_platform_sleep)(void);
	int     (*dmard06_platform_wakeup)(void);
	void    (*exit_platform_hw)(void);
};

struct battery_platform_data{
	int bat_adc_ch;//battery voltage adc channel
	int dc_adc_ch;//dc adaptor adc channel
	int hole_dc_adc_ch;//hole dc adaptor adc channel
	int (*io_init)(void);
	int (*io_deinit)(void);
};
