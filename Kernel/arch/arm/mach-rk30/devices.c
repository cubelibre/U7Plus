...
//wisky cd haung@20120423^add for wisky mid project
...
#if defined(CONFIG_KEYS_RK29)||defined(CONFIG_WISKY_KEYBOARD)
...
static void __init rk30_init_sdmmc(void)
{
	...
	//||defined(WISKY_WIFI_RTL8188EU)||defined(WISKY_WIFI_RTL8192C)//ltm++
	#else
