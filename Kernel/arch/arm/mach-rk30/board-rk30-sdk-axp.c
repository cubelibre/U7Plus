...
//改板后需要将cpu 和logic 电压调换,AXP202的DCDC2驱动能力1.6A,DCDC3驱动能力1.2A
static struct regulator_consumer_supply buck2_data[] = {
	{
		.supply = "vdd_core",//"vdd_cpu",//"dcdc2",
	},
};
//改板后需要将cpu 和logic 电压调换,AXP202的DCDC2驱动能力1.6A,DCDC3驱动能力1.2A
static struct regulator_consumer_supply buck3_data[] = {
	{
		.supply = "vdd_cpu",//"vdd_core",//"dcdc3",
	},
};
...
int platform_data_int = &axp_pdata;
#if 0  // 在 board-rk30-sdk.c中定义
...
{
	printk("%s:%d start...\n", __func__, __LINE__);
	return i2c_register_board_info(AXP_I2CBUS, axp_mfd_i2c_board_info,
