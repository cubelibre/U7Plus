...
static int usb_connect_state;	/*usb connect status*/
static void set_usb_connect_flag(int connect)
{
	usb_connect_state = connect;
}
int get_usb_connect_flag(void)
{
	return usb_connect_state;
}
EXPORT_SYMBOL(get_usb_connect_flag);
static void android_work(struct work_struct *data)
{
	...
	set_usb_connect_flag(dev->connected?1:0);
	if (uevent_envp) {
