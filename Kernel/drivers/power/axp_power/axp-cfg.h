...
*/
#define AXP_DCDC2_VALUE		1475//1400
/*
	DCDC3：
		AXP20:700~3500，25/step
		AXP19:700~3500，25/step
*/
#define AXP_DCDC3_VALUE		1375//1300//1250

/*电池容量，mAh：根据实际电池容量来定义，对库仑计方法来说这个参数很重要，必须配置*/
#if defined AXP_BATTERY_CAP
#define BATCAP				AXP_BATTERY_CAP
#else
#define BATCAP				7000//6400//4000
#endif

/*初始化电池内阻，mΩ：一般在100~200之间，不过最好根据实际测试出来的确定，方法是打开打印信息，不接电池烧好固件后，上电池，不接充电器，开机，开机1分钟后，接上充电器，充1~2分钟，看打印信息中的rdc值，填入这里*/
#if defined AXP_BATTERY_RDC
#define BATRDC				AXP_BATTERY_RDC
#else
#define BATRDC				120
#endif
/*开路电压方法中的电池电压的缓存*/
...
*/
/*开机充电电流，mA*/
#define STACHGCUR			AXP_CHARGE_CUR_LCDON//600
/*关屏充电电流，mA*/
#define EARCHGCUR			AXP_CHARGE_CUR_LCDOFF//1000
/*休眠充电电流，mA*/
...
*/
#define CHGVOL				4150//4200  //Lee
/*充电电流小于设置电流的ENDCHGRATE%时，停止充电，%*/
/*
	AXP20:10\15
	AXP19:10\15
*/ 
#define ENDCHGRATE			15//10
/*adc采样率设置，Hz*/
/*
	AXP20:25\50\100\200
	AXP19:25\50\100\200
...
*/
#if WISKY_BOARD_W008_TV10
/*
//****************6300mA*******************
#define OCVREG0				0x00		//3.1328
#define OCVREG1				0x00		//3.2736
#define OCVREG2				0x00		//3.4144
#define OCVREG3				0x01		//3.5552
#define OCVREG4				0x02		//3.6256
#define OCVREG5				0x03		//3.6608
#define OCVREG6				0x04		//3.6960
#define OCVREG7				0x0b		//3.7312
#define OCVREG8				0x10		//3.7664
#define OCVREG9				0x19		//3.8016
#define OCVREGA				0x26		//3.8368
#define OCVREGB				0x35		//3.8720
#define OCVREGC				0x46		//3.9424
#define OCVREGD				0x52		//4.0128
#define OCVREGE				0x5b		//4.0832
#define OCVREGF				0x64		//4.1536
*/
...
#define OCVREG4				0x02		//3.6256
#define OCVREG5				0x05		//3.6608
#define OCVREG6				0x06		//3.6960
#define OCVREG7				0x0b		//3.7312
#define OCVREG8				0x10		//3.7664
#define OCVREG9				0x19		//3.8016
#define OCVREGA				0x26		//3.8368
...
#define OCVREG2				0x00		//3.4144
#define OCVREG3				0x00		//3.5552
#define OCVREG4				0x05		//3.6256
#define OCVREG5				0x09		//3.6608
#define OCVREG6				0x0d		//3.6960
#define OCVREG7				0x16		//3.7312
#define OCVREG8				0x29		//3.7664
#define OCVREG9				0x34		//3.8016
#define OCVREGA				0x3b		//3.8368
#define OCVREGB				0x44		//3.8720
#define OCVREGC				0x50		//3.9424
#define OCVREGD				0x59		//4.0128
#define OCVREGE				0x60		//4.0832
#define OCVREGF				0x64		//4.1536
