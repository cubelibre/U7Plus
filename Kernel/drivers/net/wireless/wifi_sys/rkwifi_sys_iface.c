...
#endif
//wisky-lxh@20121007,wifi compatible

#if defined( CONFIG_RTL8192CU)||defined(WISKY_WIFI_RTL8192C)
    count = sprintf(_buf, "%s", "RTL8188CU");
    printk("Current WiFi chip is RTL8188CU.\n");
#endif

#if defined(CONFIG_RTL8188EU)||defined(WISKY_WIFI_RTL8188EU)
    count = sprintf(_buf, "%s", "RTL8188EU");
    printk("Current WiFi chip is RTL8188EU.\n");
#endif

//#ifdef CONFIG_RTL8188CEU
...
#if defined(CONFIG_RK903)||defined(WISKY_WIFI_RK903)
